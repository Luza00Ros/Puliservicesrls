...
- **HTML**: (_HyperText Markup Language_) è il linguaggio di markup utilizzato per strutturare il contenuto delle pagine web. È stato utilizzato per definire la struttura delle pagine e per incorporare gli elementi dell'interfaccia utente.
- ![HTML5](https://img.shields.io/badge/html5-%23E34F26.svg?style=for-the-badge&logo=html5&logoColor=white)

- **SCSS**: (_Sassy Cascading Style Sheets_) estensione del linguaggio CSS che offre funzionalità avanzate come variabili, mixin e nesting. È stato utilizzato per scrivere i file di stile CSS in modo più efficiente, modulare e riutilizzabile.
