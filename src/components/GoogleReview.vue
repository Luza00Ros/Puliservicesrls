      ...
      reviewers: [
        {
          id: 1,
          name: "Davide",
          img: "https://firebasestorage.googleapis.com/v0/b/puliservicesrls-4246e.appspot.com/o/maps_user0.png?alt=media&token=4c896ed2-8892-4e9c-915e-25b38301f8e8",
          link: "https://goo.gl/maps/wBn1juZZXNec75mP9",
          date: "11 luglio 2023",
          text: "Mi hanno fornito un servizio eccellente e di alta qualità. Ho avuto il piacere di usufruire dei loro servizi e sono rimasto estremamente soddisfatto dell'esperienza. Consiglio vivamente Puliservice SRLS a chiunque abbia bisogno di servizi di pulizia affidabili e di qualità.",
          stars: 5,
        },
      ],
    };
...
<template>
  <v-container>
    <div
      class="d-flex flex-row flex-wrap align-center justify-start"
      id="align-card"
    >
      <v-card
        id="icon-color"
        ...
        <v-window v-model="step">
          <v-window-item :value="1">
            <v-card-text>
              ...
              <v-rating
                :model-value="currentStars"
                color="amber"
                density="compact"
                half-increments
                readonly
                size="small"
                class="icon-color-stars"
              ></v-rating>

              <p class="mb-2">{{ currentText }}</p>
              <a class="link" :href="currentLink" target="_blank"
                >Guarda su Google Maps</a
              >
            </v-card-text>
          </v-window-item>
        </v-window>
