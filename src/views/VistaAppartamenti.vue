  ...
  data() {
    return {
      services: [
        ...
        { id: 5, title: 'Pulizia dei mobili e degli armadi', text: " Puliamo i mobili, gli armadi e le superfici di lavoro con panni umidi o prodotti specifici per il tipo di materiale. Rimuoviamo la polvere, le macchie e i segni evidenti.", icon: 'mdi-numeric-6' },
        { id: 6, title: 'Pulizia delle finestre e delle superfici vetrate', text: "Le finestre e le superfici vetrate sono pulite sia all'interno che all'esterno. Utilizziamo detergenti per vetri e panni puliti per rimuovere polvere, impronte digitali e macchie per una vista nitida e luminosa.", icon: 'mdi-numeric-7' },
        { id: 7, title: 'Sanificazione degli ambienti', text: "Infine, eseguiamo una sanificazione generale dell'appartamento utilizzando prodotti disinfettanti. Questo aiuta a eliminare germi, batteri e cattivi odori per creare un ambiente igienicamente sicuro.", icon: 'mdi-numeric-8' },
      ],
    }
  }
}
...
<template>
  ...
  <v-container>
    <h6 class="text-light-blue-darken-4">Garantiamo che l'appartamento sia
      completamente pulito, igienizzato e pronto per essere abitato. Di seguito elenchiamo gli interventi di pulizia che
      effettuiamo:</h6>
