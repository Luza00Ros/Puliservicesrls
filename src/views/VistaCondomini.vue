...
<template>
  ...
  <v-container>
    <h6 class="text-light-blue-darken-4"> Queste
      aree includono corridoi, scale, ingressi, ascensori, garage, e altre aree
      comuni accessibili a tutti i residenti. Di seguito elenchiamo gli interventi di pulizia che effettuiamo nei
      condomini:</h6>
